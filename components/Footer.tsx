    ...
    return (
        <footer id="contact-us" className="bg-[#0a192f] py-16 px-8 text-gray-300">
            <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
                {/* Column 1: About */}
                <div>
                    <h3 className="text-xl font-bold text-[#38bdf8] mb-6">About Kano travel & Tours</h3>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        ...
                        <li><Link href="#packages" className="hover:text-[#38bdf8] transition-colors">Packages</Link></li>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm">
                        <li className="flex items-start">
                            ...
                            <span>160 E 1, Medhananda Mawatha,<br />Pahala Bomiriya, Kaduwela,<br />Sri Lanka</span>
                        </li>
                        ...
                        <li className="flex items-center">
                            ...
                            <span>kanotravelstours@gmail.com</span>
                        </li>
                        <li className="flex items-center">
            ...
            <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
                <p>&copy; {new Date().getFullYear()} Kano travel & Tours. All rights reserved.</p>
